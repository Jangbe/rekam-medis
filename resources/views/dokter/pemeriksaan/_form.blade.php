    ...
    <form id="regForm">
        ...
        <div class="tab" id="outer">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-outline">
                    <textarea name="anamnesa" id="anamnesa" rows="5" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="tab">
            <canvas id="receipt" style="border:2px solid;"></canvas>
        ...
        <div class="d-flex justify-content-end" id="nextprevious">
            <div class="mt-3 ml-2">
                ...
                <button type="submit" class="btn btn-info" id="submit" onclick="nextPrev(1)">Submit</button>
...
@push('js')
    ...
    <script>
        ...
        function init() {
            ...
            let width = document.getElementById('outer').offsetWidth;
            canvas.width = width;
