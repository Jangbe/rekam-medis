<html lang="en" class="light-style" dir="ltr" data-theme="theme-default" data-template="vertical-menu-template-free" >
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ url('admin') }}/assets/vendor/css/pages/page-misc.css" />
    <style>
        @font-face{
            font-family: 'errorFont';
            src: url('{{ asset  ('admin/fonts/OPTISansSerifCondensedOne.otf') }}');
        }
        .error-code{
            font-family: 'errorFont';
            font-weight: bold;
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h4 class="error-code">@yield('code')</h4>
        <h2 class="mb-2 mx-2">Error @yield('code') | @yield('title') :(</h2>
        <p class="mb-4 mx-2">@yield('message')</p>
        <a href="{{ url()->previous() }}" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img src="{{ url('admin') }}/assets/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png" />
        </div>
      </div>
    </div>
    <!-- /Error -->
